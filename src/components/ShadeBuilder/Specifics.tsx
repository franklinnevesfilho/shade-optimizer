...
function Specifics({specifics, setSpecifics, onNext}: SpecificsProps) {

    const fullyAnswered =
        specifics.shadePlacement !== '' && specifics.width.value !== 0 && specifics.width.unit != '' && specifics.drop.value !== 0 && specifics.drop.unit != ''
    ...
    return (
        ...
        >
            <div className={`flex flex-col justify-center items-center gap-3`}>
                ...
                <MeasurementInput
                    label={"Width"}
                    setMeasurement={(width) => setSpecifics({...specifics, width})}
